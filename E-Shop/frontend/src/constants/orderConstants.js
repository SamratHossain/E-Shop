...
export const ORDER_DELIVER_REQUEST = 'ORDER_UPDATE_REQUEST'
export const ORDER_DELIVER_SUCCESS = 'ORDER_UPDATE_SUCCESS'
export const ORDER_DELIVER_FAIL = 'ORDER_UPDATE_FAIL'
export const ORDER_DELIVER_RESET = 'ORDER_UPDATE_RESET'
