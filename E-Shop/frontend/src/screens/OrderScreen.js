...
function OrderScreen({match}) {
    ...
    // Abo372R_cbiMAOTkLpzzXyt7Wtzdv55fYk1uQ6eKWhy5n8YJR6xwyNwYt4G1qX_E4ZvZUYMmSUUJbZPk


    const addPayPalScript = () => {
        const script = document.createElement('script')
        script.type = 'text/javascript'
        script.src = 'https://www.paypal.com/sdk/js?client-id=Abo372R_cbiMAOTkLpzzXyt7Wtzdv55fYk1uQ6eKWhy5n8YJR6xwyNwYt4G1qX_E4ZvZUYMmSUUJbZPk'
        script.async = true
        script.onload = () => {
            setSdkReady(true)
        }
